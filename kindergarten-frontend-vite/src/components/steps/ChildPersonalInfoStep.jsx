...
const ChildPersonalInfoStep = ({ data, onChange, errors }) => {
  return (
    <div>
      <h5>Datos Personales del Niño</h5>
      <p className="text-muted">Información básica del niño/a a inscribir</p>
...
export default ChildPersonalInfoStep;